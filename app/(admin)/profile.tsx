...
import { Camera, Mail, Shield, LogOut, Edit } from 'lucide-react-native';
            ...
            <TouchableOpacity style={styles.avatarContainer}>
              <View style={styles.avatar}>
                <Text style={styles.avatarText}>
                  {user?.full_name?.split(' ').map((n: string) => n[0]).join('').toUpperCase() || 'AD'}
                </Text>
              </View>
        ...
        <SafeAreaView style={styles.modalContainer}>
          ...
          <ScrollView style={styles.modalContent} showsVerticalScrollIndicator={false}>
            ...
            <TouchableOpacity
              ...
              disabled={submitting}
            >
              <LinearGradient colors={GRADIENTS.purple} style={styles.saveButtonGradient}>
                {submitting ? (
                  <LoadingSpinner />
                ) : (
